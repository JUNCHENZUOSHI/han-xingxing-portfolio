...
export const cases = {
  ...
  'sidekick-agent': {
    ...
    /* ── Narrative Hook ── */
    narrativeHook:
      '跨境商家执行 BFCM 大促这类复合经营任务，需要串联多个工具与第三方应用。本项目的核心问题不是「如何再增加一个 AI 功能」，而是「如何让 AI 围绕商家的业务目标，理解任务、规划任务、执行任务，并在出现风险或异常时让用户始终保持控制」——把本该由 AI 承担的任务协调成本从商家身上转移给 AI，让 AI 的能力做到可预测、可干预、失败可恢复。',
